...
$(function () {
  ...
  $("#form_employee").on("submit", function (e) {
    e.preventDefault();
    var data = $("#form_employee").serializeArray();
    var foto = $("#foto_profil")[0].files[0];
    var form_table = document.getElementById("form_employee");
